...
\centering
  ...
  \end{cases} $$ & $len(\cdot)$ computes the length of an input string, e.g.,
    ...
    litcost(\{s_2 : v_2; \ldots, s_n : v_n\}) \\
    		...
    		\text{else } \\
  \end{cases}
		$$ & As \texttt{\textcolor{teal}{Messsage}} is an associative array
