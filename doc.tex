...
literal  and $litGas(\ell)$, the gas consumed for storing it. Note that for certain
...
\begin{table}[!hbt]
	\caption{Gas required for storage of literals. \label{tab:storage} }
\centering
  ...
  \end{cases}
		...
		by summing up the gas required over each $t_i$. \textcolor{red}{Base case is incorrect.} \\ \hline
	\end{tabular}
	\end{table}
...
\centering
	...
	\hline
	   ...
	   \textbf{\texttt{\textcolor{teal}{Fixpoint}}}  & 1  & Rest of the gas is
		...
		\textbf{\texttt{\textcolor{teal}{Builtin}}}  & 0 & Purely dynamic gas accouting. \\ \hline
	\end{tabular}
	\end{table}
